...
tests/CMakeFiles/icon.dir/icon.c.i: cmake_force
	...
	cd /d E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\tests && "E:\Barnamenevisi\abzar ha\c++\Compiler\MinGW(7.3.0)\bin\gcc.exe" $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\tests\icon.c > CMakeFiles\icon.dir\icon.c.i
...
tests/CMakeFiles/icon.dir/icon.c.s: cmake_force
	...
	cd /d E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\tests && "E:\Barnamenevisi\abzar ha\c++\Compiler\MinGW(7.3.0)\bin\gcc.exe" $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\tests\icon.c -o CMakeFiles\icon.dir\icon.c.s
...
tests/icon.exe: tests/CMakeFiles/icon.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable icon.exe"
	cd /d E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles\icon.dir\link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/icon.dir/clean:
	cd /d E:\Barnamenevisi\Prozhe_ha\Man\engine\dependencies\glfw\tests && $(CMAKE_COMMAND) -P CMakeFiles\icon.dir\cmake_clean.cmake
